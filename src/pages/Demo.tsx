        ...
        <div className="mcontainer flex items-center justify-between">
          <div className="flex gap-5">
            <div className="flex gap-3 items-center">
              ...
              <span className="font-bold text-sm">hudy9x/komponents</span>
            </div>
            <nav className="flex items-center gap-4 text-gray-600 text-sm ml-4">
        ...
        <div className="mcontainer">
          ...
          <div className="content">
            {tabs.map((tab) => {
              ...
              const visible =
                tab.id === active ? "tab-content-active" : "hidden";
